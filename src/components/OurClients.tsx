...
export default function OurClients() {
    return (<>
        <div className="bg-[#EEEBDD] p-10">
            <h2 className="text-center text-3xl font-semibold text-black mb-4">Our Clients</h2>
            <div className="flex justify-center items-center">
                <div className="grid grid-cols-5 gap-4">
                    <div className="border-2 bg-white px-2 rounded-lg shadow-md flex justify-center items-center">
